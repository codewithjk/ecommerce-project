...
var categoryListData = [
  {
    ...
    description:
      "Headphones are a pair of small speakers used for listening to sound from a computer, music player or other such electronic device.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      "In enim justo rhoncus ut imperdiet a venenatis vitae justo. Nullam dictum felis eu pede mollis pretium integer tincidunt aenean vulputate eleifend tellus.",
  },
  {
    id: 5,
    ...
    description:
      "It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    description:
      "Beauty Care is basically the science of beauty treatment that involves skin Care, hair Care, manicure, pedicure, Anti- aging treatments, facials, styling and so on.",
  },
  {
    id: 8,
    ...
    description:
      "Books are portable and compact, and thus have an advantage over other media forms. Unlike other print media, books most often deal with a single subject.",
  },
  {
    id: 9,
    categoryImg: "/frontend/images/ecommerce/smart-watch.png",
  ...
  for (
    ...
    if (datas[i]) {
      ...
      document.getElementById("categories-list").innerHTML +=
        ...
        datas[i].categoryTitle +
        '</h5>\
                                <ul class="flex-shrink-0 list-unstyled hstack gap-1 mb-0">\
                                    <li><a href="#!" class="badge bg-info-subtle text-info  edit-list" data-edit-id="' +
        datas[i].id +
        '">Edit</a></li>\
                                    <li><a href="#delteModal" data-bs-toggle="modal" class="badge bg-danger-subtle text-danger  remove-list" data-remove-id="' +
        datas[i].id +
        '">Delete</a></li>\
                                </ul>\
                            </div>\
        ...
        '</div>\
                            <div class="mt-3">\
                                <a data-bs-toggle="offcanvas" href="#overviewOffcanvas"  data-view-id="' +
        datas[i].id +
        '" class="overview-btn fw-medium link-effect">Read More <i class="ri-arrow-right-line align-bottom ms-1"></i></a>\
                            </div>\
                            <img src="' +
        datas[i].categoryImg +
        '" alt="" class="img-fluid category-img object-fit-cover">\
                        </div>\
                    </div>\
                </div>';
    }
