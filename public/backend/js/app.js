!(function () {
        ...
        default:
          "dark" == sessionStorage.getItem("data-topbar")
            ? (x("data-topbar", "dark"),
              sessionStorage.setItem("data-topbar", "dark"),
              document.documentElement.setAttribute("data-topbar", "dark"))
            : "light" == sessionStorage.getItem("data-topbar")
            ? (x("data-topbar", "light"),
              sessionStorage.setItem("data-topbar", "light"),
              document.documentElement.setAttribute("data-topbar", "light"))
            : "brand" == sessionStorage.getItem("data-topbar") &&
              (x("data-topbar", "brand"),
              sessionStorage.setItem("data-topbar", "brand"),
              document.documentElement.setAttribute("data-topbar", "brand"));
      }
  ...
  function x(a, e) {
    Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(
      ...
      document.getElementById("collapseLayoutWidth") &&
        (Array.from(
          document.querySelectorAll('[name="data-body-image"]')
        ).forEach(function (e) {
          var t = document.getElementById("collapseLayoutWidth");
          1 == e.checked &&
            0 == document.getElementById("data-body-image-none").checked &&
            new bootstrap.Collapse(t, { toggle: !1 }).show(),
            document.querySelector("[data-bs-target='#collapseLayoutWidth']") &&
              document
                .querySelector("[data-bs-target='#collapseLayoutWidth']")
                .addEventListener("click", function (e) {
      ...
      Array.from(
        document.querySelectorAll("[name='data-layout-width']")
      ).forEach(function (e) {
        document.querySelector("[data-bs-target='#collapseLayoutWidth']") &&
          (document.querySelector(
            "#collapseLayoutWidth .form-check input:checked"
          )
            ? document
                .querySelector("[data-bs-target='#collapseLayoutWidth']")
                .classList.add("active")
...
mybutton &&
  ...
  setInterval(() => {
    var e = new Date(),
      ...
      o = 12 <= a ? " PM" : " AM",
      a =
        ("0" + (a % 12)).slice(-2) + ":" + ("0" + e.getMinutes()).slice(-2) + o;
